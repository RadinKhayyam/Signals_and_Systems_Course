...
%importing an audio
path = 'D:\sharif\signals and system\project\test_musics\'; % test musics path
song_num = 8; % music i
format = '.wav';
[downsampled_Fs, audioMono] = import_audio(path, song_num, format);

% importing an audio for part 10
% path = 'D:\sharif\signals and system\project\part 10\'; % test musics path
% song_num = 4; % music i
% format = '.m4a';
% [downsampled_Fs, audioMono] = import_audio(path, song_num, format);
